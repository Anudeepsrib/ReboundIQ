...
def run_suite(suite: str = "all"):
    ...
    sample = {
        ...
        "timestamp": "2026-...",
        "cases": [
            {"name": "resume_parse_fidelity", "status": "PASS", "notes": "stub - full in PR-19"},
    ...
    print("In full: load goldens, call gateway, LLM-judge (local only), persist to eval_runs table.")
